...
if __name__ == '__main__':
    ...
    DEFAULT_IMG_DIR = "../app/static/assets/img"
    ...
    filename = os.path.basename(args.i).replace('.docx', '.html')
    filepath = os.path.join(data_dir, filename)
    subprocess.run(['mammoth', args.i, '--output-dir=%s' % args.d])
    subprocess.run(['mv', args.d, data_dir])
